...
RSpec.describe Bots::InstructionsParser do
  describe "#instructions" do
    it "returns deserialized goes to instructions" do
      deserializer = described_class.new([
        "value 6 goes to bot 119",
        "value 7 goes to bot 102"
      ])

      expect(deserializer.call.instructions).to contain_exactly(
    ...
    it "returns deserialized gives to bot instructions" do
      deserializer = described_class.new([
    ...
    it "returns deserialized gives to output instructions" do
      deserializer = described_class.new([
